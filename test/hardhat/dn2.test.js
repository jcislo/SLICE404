...
describe("DN444 Contract - Current Behavior", function () {
  ...
  beforeEach(async function () {
    ...
    // Convert 2 TokenID 2 to 10 TokenID 1

    // Convert 4 TokenID 2 to 1 TokenID 3

    // Convert 1 TokenID 3 to 20 TokenID 1

    // Check Revert: Try to Convert 1 TokenID 1 to TokenID 2

    // Check Revert: Try to Convert 1 TokenID 2 to TokenID 3

    // Check Revert: Try to Convert 1 TokenID 3 to TokenID 0
